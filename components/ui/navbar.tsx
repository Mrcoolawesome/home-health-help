...
export default function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-background border-b border-foreground backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-row justify-between items-center h-16">
                    <Link href="/" className="text-xl font-bold text-foreground hover:text-gray-300 transition">
                        Find Referrals
                    </Link>

                    <div className="flex items-center gap-4">
                        <Link href="/about" className="text-foreground hover:text-white transition font-medium">
                            About
                        </Link>
                        {isAuthenticated ? (
                            <LogoutButton />
